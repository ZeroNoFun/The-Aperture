...
ENT.PrintName		= "Dropper (Reflection Cube)"
...
function ENT:SpawnFunction( ply, trace )
	...
	if ( !APERTURESCIENCE.ALLOWING.item_dropper && !ply:IsSuperAdmin() ) then ply:PrintMessage( HUD_PRINTTALK, "This entity is blocked" ) return end
