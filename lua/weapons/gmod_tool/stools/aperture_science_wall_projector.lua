...
function TOOL:LeftClick( trace )
	...
	MakeWallProjector( ply, trace.HitPos, trace.HitNormal:Angle(), toggle, key_enable )
...
if ( SERVER ) then
	...
	function MakeWallProjector( pl, pos, ang, toggle, key_enable )
		...
		wall_projector:SetToggle( toggleB )
