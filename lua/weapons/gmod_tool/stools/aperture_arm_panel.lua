...
if CLIENT then
	language.Add("tool.aperture_arm_panel.name", "Arm Panel")
	language.Add("tool.aperture_arm_panel.desc", "Arm Panel that can change")
	...
	language.Add("tool.aperture_arm_panel.county", "Copy Right")
