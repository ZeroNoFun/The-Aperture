...
if SERVER then
	...
	function MakeLaserEmitter(ply, pos, ang, model, key_enable, startenabled, toggle, data)
	...
	duplicator.RegisterEntityClass("ent_portal_laser_emitter", MakeLaserEmitter, "pos", "ang", "model", "key_enable", "startenabled", "toggle", "data")
...
function TOOL:LeftClick( trace )
	...
	local ent = MakeLaserEmitter(ply, pos, ang, model, key_enable, startenabled, toggle)
