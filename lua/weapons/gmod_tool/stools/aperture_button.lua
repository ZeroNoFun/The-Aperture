...
if CLIENT then
	...
	language.Add("tool.aperture_button.desc", "A button that you can press which can activate other stuff")
	language.Add("tool.aperture_button.enable", "Key to simulate")
	language.Add("tool.aperture_button.timer", "Time before release")
	language.Add("tool.aperture_button.0", "Left click to use")
end
