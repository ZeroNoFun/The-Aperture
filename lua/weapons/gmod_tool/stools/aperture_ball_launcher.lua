...
if CLIENT then
	...
	language.Add("tool.aperture_ball_launcher.desc", "A Hight Energy Pellet Launcher will shoot Hight Energy Pellets")
	...
	language.Add("tool.aperture_ball_launcher.startenabled.help", "Hight Energy Pellet Launcher will shoot Hight Energy Pellet immediately")
	language.Add("tool.aperture_ball_launcher.time", "Time to explode")
	language.Add("tool.aperture_ball_launcher.time.help", "Time will configure how long it will take to Hight Energy Pellet to be exploded")
