...
if CLIENT then
	...
	language.Add("tool.aperture_diversity_vent.desc", "A Pneumatic Diversity Vent will suck any object that is too close")
	language.Add("tool.aperture_diversity_vent.0", "Left click to use")
	language.Add("tool.aperture_diversity_vent.count", "Count")
	language.Add("tool.aperture_diversity_vent.ignorealive", "Ignore Alive")
	language.Add("tool.aperture_diversity_vent.ignorealive.help", "Diversity Vent will ignore player and NPC's")
